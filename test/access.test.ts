...
describe('Accesses', () => {
    ...
    it("should have a class with two methods and two attributes", () => {
        ...
        testAccessClsFromJSON = parsedModel.filter(el => (el.FM3 === "Famix-TypeScript-Entities.Class" && el.name === "AccessClassForTesting"))[0];
    ...
    it("should have an access to privateAttribute in privateMethod", () => {
        const famixAccess = parsedModel.filter(el =>
            (el.accessor !== undefined && el.variable !== undefined && el.FM3 === "Famix-TypeScript-Entities.Access"
